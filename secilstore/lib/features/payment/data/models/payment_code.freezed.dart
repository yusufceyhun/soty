...
abstract class $PaymentCodeCopyWith<$Res> {
  ...
  @useResult
  $Res call({String code, DateTime generatedAt, int expiresInSeconds});
}
...
/// @nodoc
@JsonSerializable()
class _$PaymentCodeImpl implements _PaymentCode {
  ...
  @override
  String toString() {
    return 'PaymentCode(code: $code, generatedAt: $generatedAt, expiresInSeconds: $expiresInSeconds)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, code, generatedAt, expiresInSeconds);
...
abstract class _PaymentCode implements PaymentCode {
  const factory _PaymentCode(
      {required final String code,
      required final DateTime generatedAt,
      final int expiresInSeconds}) = _$PaymentCodeImpl;
